...
export const testimonials = [
  {
    user: "joseph rk",
    company: "Stellar Solutions, Bangalore",
    image: user1,
    text: "I am extremely satisfied with the services provided. The team was responsive, professional, and delivered results beyond my expectations.",
  },
  {
    user: "Jane david",
    company: "Blue Horizon Technologies, cochin",
    image: user2,
    text: "I couldn't be happier with the outcome of our project. The team's creativity and problem-solving skills were instrumental in bringing our vision to life",
  },
  {
    user: "Rasna hussein",
    company: "Quantum Innovations, pune",
    image: user3,
  ...
  {
    user: "Shakkir v",
    company: "Brick & Bolt, Bangalore",
    image: user5,
    text: "Proud to be part of the team that's building smarter, faster, and better — both on-site and online.",
  },
  {
    user: "Rakish hussein",
    company: "Navy synergy System, chennai",
    image: user6,
